...
> Author: Senior React Engineer (AI-assisted)
...
**Files changed:**
- `path/to/new-component.tsx` — [one-line description]
- `path/to/modified-hook.ts` — [what changed and why]
- `path/to/new-component.test.tsx` — [test description]
...
**Tests:**
- [What was tested: unit, integration, accessibility, visual]
- [Notable edge cases covered]
- [Test execution results: pass count, coverage highlights]

**Security:**
- [What was addressed: input sanitization, auth guards, CSP, etc.]
