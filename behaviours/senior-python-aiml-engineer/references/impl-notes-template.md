...
> Author: Senior Python AI/ML Engineer (AI-assisted)
...
- `tests/evaluation/test_eval_module.py` — [evaluation test description]
...
**Tests:**
- [What was tested: unit, integration, property-based, evaluation]
- [Notable edge cases covered]
- [Test execution results: pass count, type checker status]

**AI/ML considerations:**
- [Model choices and rationale (provider, model version, parameter settings)]
- [Prompt design decisions (template structure, output format, few-shot examples)]
- [Evaluation results (accuracy, latency, cost per request, failure modes)]
- Or: "No AI/ML-specific considerations for this task"

**Security:**
- [What was addressed: input validation, prompt injection defense, PII filtering, output sanitization, etc.]
