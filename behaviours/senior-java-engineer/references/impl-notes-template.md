...
> Author: Senior Java Engineer (AI-assisted)
...
**Files changed:**
- `path/to/NewService.java` — [one-line description]
- `path/to/ModifiedRepository.java` — [what changed and why]
- `path/to/NewServiceTest.java` — [test description]
...
**Tests:**
- [What was tested: unit, integration, contract, Testcontainers]
- [Notable edge cases covered]
- [Test execution results: pass count, verification status]
